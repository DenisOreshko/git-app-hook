...
const DisconnectedIcon = () => {
    return (
            <svg version="1.1" id="Layer_1" 
                ...
                space="preserve">
            <g>
                <path className="color-h" fill="#B4BFC1" d="M480,197.45c-6.4,0-12-2.4-16.8-7.2c-116.8-116.8-305.6-116.8-422.4,0c-9.6,9.6-24.8,9.6-33.6,0
                    c-9.6-9.6-9.6-24.8,0-33.6c135.2-136,354.4-136,489.6-0.8c9.6,9.6,9.6,24.8,0,33.6C492.8,195.05,486.4,197.45,480,197.45z"/>
                <path className="color-h" fill="#B4BFC1" d="M396,282.25c-6.4,0-12-2.4-16.8-7.2c-70.4-70.4-184-70.4-254.4,0c-9.6,9.6-24.8,9.6-33.6,0
                    c-9.6-9.6-9.6-24.8,0-33.6c88.8-89.6,232.8-89.6,321.6-0.8c9.6,9.6,9.6,24.8,0,33.6C408,279.85,402.4,282.25,396,282.25z"/>
                <path className="color-h" fill="#B4BFC1" d="M309.6,362.25c-6.4,0-12-2.4-16.8-7.2c-22.4-22.4-59.2-22.4-81.6,0c-9.6,9.6-24.8,9.6-33.6,0
                    c-9.6-9.6-9.6-24.8,0-33.6c40.8-40.8,108-40.8,148.8,0c9.6,9.6,9.6,24.8,0,33.6C321.6,359.85,316,362.25,309.6,362.25z"/>
            </g>
            <g>
                <path className="color-d" fill="#ABB5B7" d="M7.2,183.05c-0.8,0.8-2.4,2.4-3.2,4c0.8,1.6,1.6,2.4,3.2,4c9.6,9.6,24.8,9.6,33.6,0
                ...
                <path className="color-d" fill="#ABB5B7" d="M91.2,267.85c-0.8,0.8-2.4,2.4-3.2,4c0.8,1.6,1.6,2.4,3.2,4c9.6,9.6,24.8,9.6,33.6,0
                ...
                <path className="color-d" fill="#ABB5B7" d="M177.6,347.85c-0.8,0.8-2.4,2.4-3.2,4c0.8,1.6,1.6,2.4,3.2,4c9.6,9.6,24.8,9.6,33.6,0
            ...
            <path className="color-krh" fill="#B4BFC1" d="M265.6,420.65l12.8-12.8c1.6-1.6,3.2-4.8,3.2-7.2s-0.8-4.8-3.2-7.2c-4-4-10.4-4-13.6,0l-12.8,12.8
            ...
            <path className="color-krd" fill="#ABB5B7" d="M264.8,393.45l-12.8,12.8l-12.8-12.8c-4-4-10.4-4-13.6,0c-4,4-4,10.4,0,13.6l12.8,12.8l-0.8,0.8
